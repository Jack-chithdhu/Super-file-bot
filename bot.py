...
class Bot(Client):
    ...
    async def start(self):
        ...
        try:
            ...
            # If peer not cached yet, store ID directly and continue
            if "Peer id invalid" in str(e):
                self.LOGGER(__name__).warning(
                    "Peer cache miss — storing CHANNEL_ID directly. "
                    "Bot will work once it receives a message from the channel."
                )
